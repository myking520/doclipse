 ...
 */
public class ProjectSelectionGroup extends Composite {
	 ...
	 */
	public ProjectSelectionGroup(Composite parent, Listener listener,
	...
	protected void createTreeViewer(int heightHint) {
		...
		ProjectFolderContentProvider cp = new ProjectFolderContentProvider();
