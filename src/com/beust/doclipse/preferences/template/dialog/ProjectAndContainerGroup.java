 ...
 */
public class ProjectAndContainerGroup implements Listener {
	// problem identifiers
	...
	// widgets
	private ProjectSelectionGroup containerGroup;
	 ...
	 *            (file, folder, project)
	 */
	public ProjectAndContainerGroup(Composite parent, Listener client,
	...
	protected void createContents(Composite parent, String resourceLabelString,
		...
		if (heightHint == SWT.DEFAULT) {
			containerGroup = new ProjectSelectionGroup(composite, this, true,
...
//		BidiUtils.applyBidiProcessing(resourceNameField, StructuredTextTypeHandlerFactory.FILE);
		BidiUtils.applyBidiProcessing(resourceNameField, "file");
		validateControls();
	}
