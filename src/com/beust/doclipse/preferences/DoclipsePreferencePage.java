...
abstract public class DoclipsePreferencePage extends PropertyPage implements IStatusChangeListener {
	protected DoclipseProject doclipseProject;
	...
	protected Control createContents(Composite parent) {
		doclipseProject = DoclipsePlugin.getDoclipseProject(this.getElement().getAdapter(IProject.class));
		return null;
	}
	...
	public Map getCheckedFiles(Table table) {
