...
//    result.setLayoutData(gd);
  ...
  private void initializeValues() {
    if (isPlugin()) {
      m_surroundWithDoubleQuotesB.setSelection(Preferences.surroundWithDoubleQuotes());
      m_insertSpacesB.setSelection(Preferences.insertSpacesAroundEqual());
    }
  }
  ...
  private void savePreferences() {
    ...
    //
    Preferences.saveSurroundWithDoubleQuotes(m_surroundWithDoubleQuotesB.getSelection());    
    Preferences.saveInsertSpacesAroundEqual(m_insertSpacesB.getSelection());    
  }
